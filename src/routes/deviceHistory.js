 ...
 *     description: Retorna las últimas métricas registradas para un dispositivo específico. Opcionalmente se pueden filtrar métricas específicas.
 *     tags: [Device History]
 *     parameters:
 *       - in: path
 *         name: deviceId
 ...
 *     description: Retorna la evolución de una métrica en un rango de fechas con agregación temporal configurable.
 *     tags: [Device History]
 *     parameters:
 *       - in: path
 *         name: deviceId
 ...
 *     description: Retorna múltiples métricas para un dispositivo en un período específico con agregación temporal.
 *     tags: [Device History]
 *     parameters:
 *       - in: path
 *         name: deviceId
 ...
 *     description: Retorna los metadatos y información básica de un dispositivo específico.
 *     tags: [Device History]
 *     parameters:
 *       - in: path
 *         name: deviceId
 ...
 *     description: Retorna una lista de todas las métricas que están disponibles para un dispositivo específico.
 *     tags: [Device History]
 *     parameters:
 *       - in: path
 *         name: deviceId
 ...
 *     description: Limpia el cache de metadatos de dispositivos del servicio de historial.
 *     tags: [Device History]
 *     responses:
 *       200:
 ...
 *     description: Resetea todas las estadísticas de rendimiento del servicio de historial de dispositivos.
 *     tags: [Device History]
 *     responses:
 *       200:
